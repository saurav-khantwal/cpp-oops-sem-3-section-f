...
public:
    ...
    lwpa()
    {
       ...
       cout<<"the area of the ractangle is "<<endl<<length*width<<endl<<endl;
       square();
    }
    square()
    {
        if(length==width)
        {
            cout<<"this rectangle is a square"<<endl<<endl;
            setperimeter();
        }

        else
        {
            cout<<"this is a rectangle"<<endl<<endl;
            setperimeter();
        }
    ...
    setperimeter()
    {
        cout<<"input the character for the border box"<<endl;
        cin>>border;
        setfill();
    }
    setfill()
    {
        cout<<"input the character for body of rectangle:"<<endl;
        cin>>body;
        cout<<endl;
        draw();
    }
